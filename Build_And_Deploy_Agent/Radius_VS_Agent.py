...
# MAGIC
# MAGIC #TODO: Specify system prompt for your use case
...
# MAGIC     VectorSearchRetrieverTool(
# MAGIC         # TODO: specify index name and description for better agent tool selection
# MAGIC         index_name="ankit_yadav.uct_schema.ankit_yadav_uct_index",
# MAGIC         tool_description="Vector Search tool which can be queried to get additional context on Ultra Clean Technology products. This database contains information about Ultra Clean Teachnology products and their usage scenarios along with its technical specifications."
# MAGIC     )
# MAGIC ]
...
input_example = {
    "messages": [
        {
            "role": "user",
            "content": "What is the use of the HRG regulators?" #TODO: Add custom example
        }
    ]
}
